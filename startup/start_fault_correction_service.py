...
"""
This module starts the alarm manager service found in ../services/fault_correction_service.py in a new process.
"""

def start_fault_correction_service(ok_queue=None):
    config = load_config("startup/startup.conf")
    fault_correction_service = FaultCorrectionService(config["digital_twin"]["fault_correction_service"])
